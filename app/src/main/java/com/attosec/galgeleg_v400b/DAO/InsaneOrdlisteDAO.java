...
/**
 * Created by nicolaihansen on 20/01/16.
 */
public class InsaneOrdlisteDAO implements IOrdlisteDAO {
    private ArrayList<String> ordliste = new ArrayList<>();
    private Query queryRef;
    private Firebase firebaseRef;
    private ChildEventListener childEventListener;

    public InsaneOrdlisteDAO() {
        firebaseRef = new Firebase("https://galgeleg.firebaseio.com/insanewordlist");
